...
int main()
{
    RenderWindow window;
    Font font;
    SoundBuffer themeBuffer, gameoverBuffer, leveldestroyedBuffer;
    Sound themeSound, gameoverSound, leveldestroyedSound;
    Text destroyedLevelsCount, startGameText, nextTetraminoText, escapeText;
    Texture texture, texture_background, texture_playingField;
    Sprite sprite, sprite_background, sprite_field;
    Menu menu(window);
